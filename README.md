...
* Full Stack SoftWare Engineer | Lead DevOps Engineer | Azure | AWS | GCP | Docker | Kubernetes |Terraform | Ansible | Jenkins | SRE | NodeJS | Golang  | JAVA | Flutter | Python | Ansible | Microservices  *
